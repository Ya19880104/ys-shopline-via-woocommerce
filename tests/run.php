...
require __DIR__ . '/YSVirtualAccountResponseContractTest.php';
...
require __DIR__ . '/YSSubscriptionActivationContractTest.php';
require __DIR__ . '/YSNewOrderEmailContractTest.php';
...
ys_run_virtual_account_response_contract();
...
ys_run_subscription_activation_contract();
ys_run_new_order_email_contract();
