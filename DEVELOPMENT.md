...
├── src/                                 # 新架構（PSR-4）
│   ├── Api/
│   │   ├── YSShoplineClient.php        # API 客戶端
│   │   └── YSShoplineRequester.php     # HTTP 請求器
│   │
│   ├── Blocks/
│   │   ├── YSBlocksSupport.php
...
│   │
│   ├── Gateways/
│   │   ├── YSAbstractGateway.php
│   │   └── YSRedirectGateway.php
│   │
│   ├── Handlers/
...
| 架構 | 位置 | 命名規則 | 說明 |
|------|------|---------|------|
| 舊架構 | `includes/` | `YS_Shopline_*` | 維護中，確保相容性 |
| 新架構 | `src/` | `YS*` (PSR-4) | 主要開發方向 |
